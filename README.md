...
[![Quality gate](https://sonarcloud.io/api/project_badges/quality_gate?project=DiscordBot)](https://sonarcloud.io/summary/new_code?id=DiscordBot)
...
- `play` (`src/commands/learning/play.js`): Joins the caller's voice channel and plays a selected MP3 from `src/assets/music/` (or `src/assets/audio/`). Cleans up when playback ends or on error.
